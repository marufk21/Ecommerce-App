...
<div className="flex items-center py-4 border-b border-gray-300">
  ...
  <div className="flex flex-col justify-between ml-4 flex-grow">
    <div className="flex justify-between items-center">
      ...
      <FaTrash className="text-gray-400 hover:text-red-500 cursor-pointer" onClick={() => removeItem(id)} />
    </div>
    <div className="flex items-center mt-2">
      <p className="mr-2 font-medium text-gray-500">Color:</p>
      <div className="w-4 h-4 rounded-full" style={{ backgroundColor: color, color: color }}></div>
    </div>
    <div className="flex items-center mt-2">
      <p className="font-medium text-gray-500">Price:</p>
      <p className="ml-2 font-semibold"><FormatPrice price={price} /></p>
    </div>
    <div className="flex items-center mt-2">
    ...
    <div className="flex items-center mt-2">
      ...
      <p className="ml-2 font-semibold"><FormatPrice price={price * amount} /></p>
    </div>
  </div>
</div>
